            ...
            {isSubmitted ? (
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                ...
                <div>
                  ...
                  <textarea required name="message" rows={6} placeholder="Tell me about your project..." className={`${inputClass} resize-none`} data-testid="input-message" />
                </div>
                {error && (
                ...
                <div className="border-t border-white/10 pt-5 flex items-center justify-between mt-1">
                  <button
                    ...
                    className="flex items-center gap-2 border border-white/30 px-6 py-2.5 font-mono text-[10px] tracking-widest uppercase text-white/70 hover:text-white hover:border-white transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                  >
